...
# -*- encoding: utf-8 -*-
# stub: rbbt-sources 3.1.53 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.test_files = ["test/test_helper.rb".freeze, "test/rbbt/sources/test_HPRD.rb".freeze, "test/rbbt/sources/test_pina.rb".freeze, "test/rbbt/sources/test_tfacts.rb".freeze, "test/rbbt/sources/test_pubmed.rb".freeze, "test/rbbt/sources/test_gscholar.rb".freeze, "test/rbbt/sources/test_entrez.rb".freeze, "test/rbbt/sources/test_biomart.rb".freeze, "test/rbbt/sources/test_go.rb".freeze, "test/rbbt/sources/test_organism.rb".freeze, "test/rbbt/sources/test_matador.rb".freeze, "test/rbbt/sources/test_pharmagkb.rb".freeze, "test/rbbt/sources/test_synapse.rb".freeze, "test/rbbt/sources/test_stitch.rb".freeze, "test/rbbt/sources/test_kegg.rb".freeze, "test/rbbt/sources/test_string.rb".freeze]

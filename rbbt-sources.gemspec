...
# -*- encoding: utf-8 -*-
# stub: rbbt-sources 3.1.8 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.test_files = ["test/test_helper.rb", "test/rbbt/sources/test_pubmed.rb", "test/rbbt/sources/test_string.rb", "test/rbbt/sources/test_gscholar.rb", "test/rbbt/sources/test_biomart.rb", "test/rbbt/sources/test_go.rb", "test/rbbt/sources/test_pina.rb", "test/rbbt/sources/test_entrez.rb", "test/rbbt/sources/test_pharmagkb.rb", "test/rbbt/sources/test_organism.rb", "test/rbbt/sources/test_matador.rb", "test/rbbt/sources/test_tfacts.rb", "test/rbbt/sources/test_kegg.rb", "test/rbbt/sources/test_synapse.rb", "test/rbbt/sources/test_stitch.rb", "test/rbbt/sources/test_HPRD.rb"]
